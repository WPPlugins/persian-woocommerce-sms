...
* بروز رسانی sms.ir و عدم نیاز به تنظیم مجدد محصولات قدیمی برای مدیر محصول
= 3.2.1 =
* رفع پیغام بعد از بروز رسانی
= 3.2.0 =
* بعد از بروز رسانی به راهنمایی ذکر شده در تاپیک مربوطه در پرشین اسکریپت مراجعه کنید
= 3.1.0 =
* بعد از بروز رسانی حتما یکبار تمام تب های تنظیمات پیامک را مجددا ذخیره نمایید :
* سازگاری با sms.ir - s1.websms.ir - payam-resan.com - azaranpayamak.ir - idehpayam.com -
* قابلیت های اساسی دیگر
= 3.0.3 =
* تغییر در وبسرویس LimooSMS
= 3.0.2 =
* بهبود متاباکس موجود در صفحه محصول
